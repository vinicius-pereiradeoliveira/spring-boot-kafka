...
```
cd existing_repo
git remote add origin https://gitlab.com/vinicius_oliveira/spring-kafka.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/vinicius_oliveira/spring-kafka/-/settings/integrations)
